...
<!-- 2019년에 있었던 주요 이벤트와 이야기 하자면 다음과 같다.
...
> 나는 유일한 프론트엔드 엔지니어다
<!-- ![iamlegend](/retrospective-2019/iamlegend.jpg) -->
...
<!-- 
상대적으로 개발 커리어를 늦게 시작했다고 느껴서 그런지 코딩을 하지 않거나 개발공부를 하지 않을 때는 뭔가 불안함을 느끼곤 했다.

이러한 불안감이 성장을 만들어 주긴 했지만 관계에 있어 아쉬움을 남겼다.



2020년에는 개발과 인생의 균형을 맞추기 위해 조금 더 노력하려고 한다. 




2019년 2월, 개발자로서 한 조직 내에 몸을 담게 되었다. 15명 남짓한 작은 스타트업이다. 조직이 작은 만큼 다른 포지션과 가까이서 업무를 진행하였다. 
 동료들에게 요구사항을 받고, 내가 역 제안을 하기도 하며 **협업**이란 형태의 업무를 
 법인을 달고 있는 서비스에 내가 작성한 코드가 들어가고

그래서 난 무엇을 느꼈을까? 내가 주요하게 느꼈던 것들을 질답형식으로 나열해보려고 한다.

### 1. 훌륭한 개발자란?

훌륭한 개발자가 되려면 어떤 개발자가 훌륭한 개발자인지 기준을 정해야 할 것이다. 내가 생각하던 훌륭한 개발자는 다음과 같았다.

1. 코딩을 잘한다.
2. OS와 네트워크 이론을 잘 이해하고 있다.
3. 고객(기획자)의 말을 잘 알아 듣고 구현한다.

이 외에도 여러가지 가치가 있겠지만 주요한 가치는 이런 것들이다. 
